# -------------------------------------------------------------
# EOF1 and Global SST Regression
# -------------------------------------------------------------
...
reg_map = cor_map * sst_analysis.std(dim='year') / pcs.std()
...
ax1.set_title(
    f"Global DJF SST Regression onto Tropical Pacific PC1 "
    f"({analysis_label})"
)
...
cbar.set_label("Regression Coefficient (°C)")
