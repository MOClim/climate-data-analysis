...
# Student directions:
#
# 1. Set the station ID to:
#       47678  (Hachijojima, Japan)
#
# 2. Select the sounding date:
#       2024-08-14
#
# 3. Radiosonde archives use UTC time.
