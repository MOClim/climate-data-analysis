# ---------------------------------------------------------
# Global Robinson Projection Map of DJF Sea Level Pressure
# ---------------------------------------------------------
#
# This program plots the DJF mean sea level pressure (SLP)
# using a Robinson global map projection.
#
# This global view can be used to introduce large-scale
# atmospheric circulation before focusing on polar climate
# variability with polar stereographic projections.
#
# In this example, we:
#
...
# 4. Create a Robinson global projection.
# 5. Plot DJF sea level pressure using filled contours.
# 6. Overlay sea level pressure contour lines.
# 7. Add coastlines, borders, and latitude-longitude gridlines.
#
# ---------------------------------------------------------
